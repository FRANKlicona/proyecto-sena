            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Actividades de
                        <?= strtoupper($_REQUEST['c']); ?><a class="btn btn-primary btn-round pull-right" href="?c=psicologia&a=Crud"><i class="now-ui-icons ui-1_simple-add"></i></a>
                    </h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-warning btn-round" href="?c=psicologia&a=Crud&id=<?php echo $r->id; ?>"><i class="now-ui-icons ui-2_settings-90"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a type="button" class="btn btn-link btn-neutral" href="?c=psicologia&a=Eliminar&id=<?php echo $r->id; ?>">SI</a>
